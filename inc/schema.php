...
$graph[] = [
  ...
  '@id'         => $ORG_ID,
  'name'        => $site_name,
  'legalName'   => 'Aiqon Quickcool SDN BHD',
  'identifier'  => ['@type' => 'PropertyValue', 'name' => 'SSM', 'value' => '202501034949'],
  'url'         => $base . '/',
  'image'       => $logo,
  'logo'        => $logo,
  ...
  'address'     => [
    '@type'           => 'PostalAddress',
    'streetAddress'   => 'No. 42 Jalan SCI 1/12, Dataran Sunway City Ipoh',
  ...
  'geo'         => ['@type' => 'GeoCoordinates', 'latitude' => 4.6009, 'longitude' => 101.0829],
