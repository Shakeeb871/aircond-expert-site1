...
<section class="section"><div class="wrap"><div class="contact-grid">
  <div class="cinfo">
    ...
    <div class="ci"><span class="ic"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M21 10c0 7-9 12-9 12s-9-5-9-12a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg></span><div><h4>Coverage</h4><p>Across Kuala Lumpur and Selangor</p></div></div>
