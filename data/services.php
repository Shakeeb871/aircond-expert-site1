...
return [
  'aircond-service' => [
    ...
    'desc' => 'Professional aircond service across Ipoh, Perak Darul Ridzuan. Cleaning, gas and drainage checks for stronger cooling and lower bills.',
    'keywords' => ['aircond service Ipoh, Perak Darul Ridzuan','aircond servicing Ipoh','aircond cleaning','split unit service','aircond maintenance Malaysia','aircond service near me','Daikin aircond service','Panasonic aircond service','Mitsubishi aircond service'],
    'intro' => [
      ...
      'Most homes in Ipoh, Perak Darul Ridzuan need an aircond service every three to four months, more often if you run the unit daily or live near dust and traffic. We service all major brands including Daikin, Panasonic, Mitsubishi, York, Acson, Hitachi and Midea, and always agree the price before we start.'
    ],
    'benefits' => [
    ...
    'sections' => [
      ...
      ['Aircond Service for Every Brand', '<p>Our technicians service every major brand &mdash; Daikin, Panasonic, Mitsubishi Electric, York, Acson, Hitachi, Hisense, Haier and Midea &mdash; for wall split, cassette and inverter systems. Wherever you are in Ipoh, Perak Darul Ridzuan, from Kuala Lumpur and Petaling Jaya to Subang, Cheras and Klang, a local technician is close by.</p>'],
    ],
    'process' => [
  ...
  'chemical-wash' => [
    ...
    'desc' => 'Aircond chemical wash service in Ipoh, Perak Darul Ridzuan. A full coil and blower deep clean for units that cool poorly or smell musty.',
    'keywords' => ['aircond chemical wash','chemical wash Ipoh, Perak Darul Ridzuan','aircond deep cleaning','aircond mould removal','split unit chemical wash','aircond overhaul','chemical wash KL','aircond smell removal'],
    'intro' => [
      ...
      'The job takes around 90 to 120 minutes per unit. We dismantle the relevant parts, treat them with proper coil chemicals, flush everything clean, then reassemble and test the cooling before we leave. We chemical wash all major brands across Ipoh, Perak Darul Ridzuan.'
    ],
    'benefits' => [
    ...
    'sections' => [
      ['When Does Your Aircond Need a Chemical Wash?', '<p>A chemical wash is the right choice when a routine service no longer restores performance. Consider one if you notice:</p><ul><li>Cooling that stays weak even after a normal service</li><li>A persistent musty or sour smell</li><li>Visible black mould or slime on the coil or blower</li><li>Water leaking from the indoor unit</li><li>It has been over a year since the last deep clean</li></ul>'],
      ['What a Chemical Wash Removes', '<p>Over time, dust, mould, bacteria and a slimy bio-film build up inside the coil, blower wheel and drainage tray &mdash; places a surface wipe can never reach. Our chemical treatment dissolves and flushes all of it out, then an anti-bacterial rinse leaves the unit hygienic and the air fresh.</p>'],
      ['Chemical Wash vs Normal Service', '<p>A normal service is routine upkeep &mdash; filters, a coil wipe, drainage and checks. A chemical wash is a deep overhaul for units that are already struggling. If you are unsure which you need, send us a photo and a short description and we will advise honestly.</p>'],
    ],
    'process' => [
  ...
  'aircond-repair' => [
    ...
    'desc' => 'Aircond repair across Ipoh, Perak Darul Ridzuan. Capacitor, PCB, fan motor, compressor and gas faults diagnosed and fixed fast.',
    'keywords' => ['aircond repair Ipoh, Perak Darul Ridzuan','aircond not cooling','aircond repair KL','aircond water leaking','aircond compressor repair','aircond PCB repair','aircond capacitor replacement','emergency aircond repair'],
    'intro' => [
      ...
      'We show you the faulty part before we replace it and agree the price first. No guesswork, and no pressure to replace a whole unit when a single component is the problem. We repair all major brands across Ipoh, Perak Darul Ridzuan.'
    ],
    'benefits' => [
    ...
    'sections' => [
      ...
      ['Aircond Repair for All Brands', '<p>We repair Daikin, Panasonic, Mitsubishi, York, Acson, Hitachi, Hisense, Haier and Midea units across Kuala Lumpur, Petaling Jaya, Subang, Cheras, Shah Alam, Klang and the wider Ipoh, Perak Darul Ridzuan, with same-day slots where available.</p>'],
    ],
    'process' => [
  ...
  'installation' => [
    ...
    'desc' => 'Aircond installation in Ipoh, Perak Darul Ridzuan. Wall split supply and fit with OEM brackets, copper pipe and a one-year workmanship warranty.',
    'keywords' => ['aircond installation Ipoh, Perak Darul Ridzuan','aircond installation KL','split unit installation','new aircond install','aircond supply and install','aircond fit only','copper piping installation','aircond mounting'],
    'intro' => [
      ...
      'We can supply the unit or install one you already bought. Every aircond installation across Ipoh, Perak Darul Ridzuan carries a one-year workmanship warranty in writing.'
    ],
    'benefits' => [
    ...
    'sections' => [
      ...
      ['Supply &amp; Install or Fit-Only', '<p>Already bought a unit? We offer fit-only installation. Need the unit too? We can supply genuine units from trusted brands and install them in one visit, anywhere in Ipoh, Perak Darul Ridzuan.</p>'],
    ],
    'process' => [
  ...
  'gas-top-up' => [
    ...
    'desc' => 'Aircond gas top-up in Ipoh, Perak Darul Ridzuan. Leak detection first, then the correct refrigerant (R32, R410A, R22) and a pressure test.',
    'keywords' => ['aircond gas top up','aircond refrigerant refill','aircond gas Ipoh, Perak Darul Ridzuan','R32 gas top up','R410A refill','aircond not cold gas','aircond leak detection','aircond gas charging KL'],
    'intro' => [
      ...
      'Once any leak is sealed, we charge the correct refrigerant for your unit &mdash; R32, R410A or R22 &mdash; and pressure test it so the cooling holds. We serve homes and businesses across Ipoh, Perak Darul Ridzuan.'
    ],
    'benefits' => [
    ...
    'sections' => [
      ['Signs Your Aircond Is Low on Refrigerant', '<p>Low gas shows up in a few clear ways:</p><ul><li>The unit runs but the air is not cold</li><li>It takes much longer to cool the room</li><li>Ice or frost forms on the pipes or coil</li><li>Hissing or bubbling sounds from the unit</li><li>Electricity bills creep up as the unit overworks</li></ul>'],
      ['Why We Check for Leaks First', '<p>Refrigerant does not get &ldquo;used up&rdquo; &mdash; if it is low, it has leaked out. Topping up a leaking system is money down the drain because the gas escapes again within weeks. We locate and seal the leak first, then charge the correct amount so the fix lasts.</p>'],
      ['Refrigerant Types: R32, R410A and R22', '<p>Different units use different refrigerants. We carry R32, R410A and R22 and charge the exact type your unit is rated for, to the correct pressure, then verify the temperature drop before we leave.</p>'],
    ],
    'process' => [
  ...
  'general-cleaning' => [
    ...
    'desc' => 'Aircond general cleaning in Ipoh, Perak Darul Ridzuan. Filter and cover wash that restores airflow and keeps room air fresh between full services.',
    'keywords' => ['aircond general cleaning','aircond filter cleaning','aircond basic cleaning','aircond cleaning Ipoh, Perak Darul Ridzuan','aircond cleaning KL','aircond dust removal','aircond cover wash'],
    'intro' => [
      ...
      'We wash the filters and front cover, wipe the visible parts, and check that the unit is draining and cooling as it should. Available for homes and offices across Ipoh, Perak Darul Ridzuan.'
    ],
    'benefits' => [
    ...
    'sections' => [
      ['What General Aircond Cleaning Covers', '<p>General cleaning is a light maintenance visit. We remove and wash the filters, wipe down the front cover and visible parts, clear visible dust, and do a quick check that the unit is draining and cooling properly. It keeps airflow strong and the air fresh between full services.</p>'],
      ['General Cleaning vs Full Service', '<p>General cleaning is a surface refresh; a full aircond service also cleans the coil and blower and checks the gas and electricals. If your cooling has dropped or the unit smells, a full service or chemical wash is the better choice &mdash; we will tell you honestly.</p>'],
      ['Keep Your Aircond Fresh Between Services', '<p>A general clean every month or two, plus a quick monthly filter rinse, keeps dust down and airflow strong. It is an easy, low-cost habit that helps your unit cool better and last longer in Malaysia&rsquo;s climate.</p>'],
    ],
    'process' => [
