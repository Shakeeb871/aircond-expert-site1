...
$page_desc='Licensed 24-hour aircond service, repair, chemical wash, gas top-up and installation across Ipoh, Perak Darul Ridzuan. All major brands, fixed pricing, 15-minute WhatsApp reply.';
$active='home';
...
<section class="section services2" id="core">
  <div class="wrap center">
    ...
    <h2 style="margin-top:12px">Professional Air Conditioning Solutions for Every Need</h2>
    <p class="sub">We deliver reliable, fast and professional aircond services to keep your home cool, efficient and comfortable all year round.</p>
  </div>
  <div class="wrap">
...
<section class="section about" id="about">
  <div class="wrap about-grid">
    ...
    <div class="about-content reveal">
      ...
      <p>We are a team of licensed, in-house aircond technicians serving Ipoh, Perak Darul Ridzuan. No subcontractors, no guesswork, no surprise invoices. Just clean, careful work and a unit that cools the way it should.</p>
...
<section class="section whychoose">
  <div class="wrap center">
    ...
    <p class="sub">A decade of clean, careful work across Ipoh, Perak Darul Ridzuan — and the numbers our customers trust us by.</p>
  </div>
  <div class="wrap"><div class="ws-grid reveal" id="stats">
    <div class="wsc t-lav">
      <span class="ws-num"><span data-c="1000">0</span><span class="y">+</span></span>
      <span class="ws-lbl">Units serviced and installed across Ipoh, Perak Darul Ridzuan</span>
    </div>
    <div class="wsc t-yel">
...
<section class="serving" id="areas">
  <div class="wrap center">
    ...
    <h2>Serving homes &amp; businesses across Ipoh, Perak Darul Ridzuan</h2>
